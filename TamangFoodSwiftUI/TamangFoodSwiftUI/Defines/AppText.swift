...
struct AppText {
    ...
    static let titleCreateAccount = "Create Account"
    ...
    static let descriptionCreateAccount = "Enter your Name, Email and Password\nfor sign up."
    ...
    static let fullNameTitleTextField = "FULL NAME"
    static let alreadyHaveAccountText = "Already have account?"
    static let signInText = "SIGN IN"
    static let signUpText = "SIGN UP"
    static let resetPasswordText = "RESET PASSWORD"
    static let policyText = "By Signing up you agree to our Terms\nConditions & Privacy Policy."
    ...
    static let titleNaviVerifyPhoneNumber = "Login to Foodly"
    static let titleVerifyPhoneNumber = "Verify Phone Number"
    static let descriptionVerifyPhoneNumber = "Enter the 4-Digit code sent to you at \n+610489632578"
    static let continueText = "Continue"
    static let resendText = "Resend Again"
    static let didNotReceiveCodeText = "Didn't receive code?"
}
